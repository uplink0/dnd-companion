...
INSERT INTO characters(id,campaign_id,kind,name,race,class_name,rank,level,xp,xp_next,hp,hp_max,armor_class,initiative,abilities) VALUES
('30000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000001','COMPANION','Лира','Человек','Следопыт','Союзник',5,6500,14000,41,41,16,4,'{"str":11,"dex":18,"con":14,"int":10,"wis":16,"cha":12}'),
('30000000-0000-4000-8000-000000000003','10000000-0000-4000-8000-000000000001','COMPANION','Бром','Дварф','Воин','Союзник',5,7100,14000,48,48,18,1,'{"str":18,"dex":10,"con":18,"int":9,"wis":12,"cha":10}') ON CONFLICT DO NOTHING;
...
('10000000-0000-4000-8000-000000000001','30000000-0000-4000-8000-000000000003','INVITED') ON CONFLICT DO NOTHING;
...
INSERT INTO messages(campaign_id,session_id,role,body) SELECT '10000000-0000-4000-8000-000000000001','20000000-0000-4000-8000-000000000001','MASTER','Свиток выглядит старым, но хорошо сохранившимся. На нём — символ культа. Что вы хотите сделать дальше?' WHERE (SELECT count(*) FROM messages)=1;
